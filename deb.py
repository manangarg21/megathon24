...
# Assuming you have a tokenizer and model defined already
...
# Tokenize texts
train_texts_encodings = tokenizer(train_texts.tolist()[:5000], padding="max_length", truncation=True, max_length=512, return_tensors="pt")
test_texts_encodings = tokenizer(test_texts.tolist()[:5000], padding="max_length", truncation=True, max_length=512, return_tensors="pt")
